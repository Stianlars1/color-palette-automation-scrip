...
import {hexToHSLString, hslToHex} from "@/lib/utils/color/colorConverters";
import {AdvancedColorTheory} from "@/lib/ColorTheory";
import {ColorPalette, GeneratedPalette, RadixColorScale, Scheme} from "@/types/types";
...
export class ColorPaletteAutomation {
    ...
    async generateRadixPalette(colors: ColorPalette): Promise<GeneratedPalette> {
        ...
        const css = generateCSS(accentScale, grayScale);
